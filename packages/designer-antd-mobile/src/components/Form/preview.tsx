...
import { Form as FormilyForm } from '@qiaoyuwen-core-next/formily-antd-mobile';
import { usePrefix, DnFC } from '@qiaoyuwen-core-next/designer-react';
  ...
  designerProps(node) {
    return {
      ...
      propsSchema: {
        type: 'object',
        properties: {
          ...(AllSchemas.Form.properties as any),
        },
      },
      defaultProps: {
        labelCol: 6,
