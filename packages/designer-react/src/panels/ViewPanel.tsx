...
import { TreeNode, ITreeNode, WorkbenchTypes } from '@qiaoyuwen-core-next/designer-core'
...
export const ViewPanel: React.FC<IViewPanelProps> = observer<IViewPanelProps>((props) => {
